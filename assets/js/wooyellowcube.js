jQuery(document).ready(
    ...
    */
        $('.wooyellowcube_authentification').on(
            'change', function () {
    ...
    */
        $('#wooyellowcube-product-update').on(
            'click', function () {
    ...
    */
        $('#wooyellowcube-product-refresh').on(
            'click', function () {
    ...
    */
        $('#wooyellowcube-order-refresh').on(
            'click', function () {
        ...
        $('.wooyellowcube-product-variation-send').on(
            'click', function () {
    ...
    * Metabox - Product - Update to YellowCube
    */
        $('.wooyellowcube-product-variation-update').on(
            'click', function () {
